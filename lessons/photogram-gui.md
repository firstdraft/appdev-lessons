...
- Notes:
  ...
  - [Video](https://canvas.uchicago.edu/courses/41147/pages/video-photogram-gui){target="_blank"} transcription is in [`photogram-gui.md`](https://github.com/firstdraft/appdev-chapters/blob/benp-edits/photogram-gui.md){target="_blank"}
