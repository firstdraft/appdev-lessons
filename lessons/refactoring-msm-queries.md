...
- Notes:
  ...
  - [Original video](https://uchicago.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=69b47533-78a4-40f4-80a1-aed9010f30f8){target="_blank"} transcription is in [`refactoring-MSM-queries.md`](https://github.com/firstdraft/appdev-chapters/blob/benp-edits/refactoring-MSM-queries.md){target="_blank"}
